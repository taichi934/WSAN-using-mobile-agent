...
########################################################################################
    ...
    def synchronize(self,txBuf,  rxLen):
        ...
        if self.__isSynchronize == False:
            ...
            self.com.reset_input_buffer() # renamed from flushInput()
    ...
    def open(self,comName,bundrate,timOut):
        if self.isComOK == 0:# if self.com == 0:
            # try:
                # self.com = serial.Serial(comName,bundrate,parity='E',stopbits =1,timeout=timOut)
                self.com = serial.Serial(comName,bundrate,parity=serial.PARITY_EVEN,stopbits=serial.STOPBITS_ONE,timeout=timOut)
                print(1)
                # self.com.flushInput()#
                self.com.reset_input_buffer() # renamed from flushInput()
   ...
   #///////////////////////////////////////////////////////////////////////////////////
    ...
    def motionPlay(self,motionNum):
        ...
        if self.suspend() == False:
            ...
            print(f"suspend motion{motionNum}")
